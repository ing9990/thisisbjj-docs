...
[대시보드](dashboard.md)에서 **"출석 시 벨트 설정"** 토글을 켜면, 벨트가 미설정된 신규 회원이 체크인할 때 **벨트 색상 선택 화면**이 자동으로 나타납니다.

<figure><img src=".gitbook/assets/출석체크 벨트설정 기능.gif" alt="출석 시 벨트 설정"><figcaption>체크인 → 벨트 색상 선택 → 설정 완료</figcaption></figure>
