...
* [🔑 로그인](getting-started/login.md)
* [📱 전화번호 인증](getting-started/phone-verification.md)
* [🏢 지도자 인증 (사업자 인증)](getting-started/leader-verification.md)
* [✅ 셋업 체크리스트](getting-started/setup-checklist.md)

## 도장 운영 <a href="#management" id="management"></a>
...
* [📝 계약서 관리](contracts/README.md)
  ...
  * [✍️ 회원 서명 과정](contracts/signing-flow.md)
  * [📄 서명된 계약서 관리](contracts/signed-management.md)
* [🖥️ 출석 & 키오스크](attendance/README.md)
